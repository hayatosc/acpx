...
- Output/reads: add a `--suppress-reads` flag that suppresses raw `read` file contents while preserving the selected output format for agent-to-agent pipelines. (#134) Thanks @hayatosc.
